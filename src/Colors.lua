...
#####  Palette URL: http://paletton.com/#uid=72V0u0kllllaFw0g0qFqFg0w0aF
...
local hex = {
   {'#2A7E43','#7EBD91','#4F9D66','#105E27','#003F13'},
   {'#265B6A','#6B939F','#447684','#0F414F','#022A35'},
   {'#AA7239','#FFD5AA','#D4A06A','#804B15','#552B00'},
   {'#AA4839','#FFB6AA','#D4796A','#802415','#550C00'},
}
return hex
